...
public class AdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView listViewAdminFood = findViewById(R.id.listViewAdminFood);
        ...
        listViewAdminFood.setOnItemClickListener((parent, view, position, id) -> showFoodEditorDialog(id));
    ...
    private void showFoodEditorDialog(final Long foodId) {
        ...
        builder.setPositiveButton(foodId == null ? "Añadir" : "Actualizar", (dialog, which) -> saveFoodItem(foodId, editTextName, editTextDescription, editTextPrice, editTextCategory));

        builder.setNegativeButton("Cancelar", (dialog, which) -> dialog.dismiss());

        if (foodId != null) {
            builder.setNeutralButton("Eliminar", (dialog, which) -> new AlertDialog.Builder(AdminActivity.this)
    ...
    private void loadFoodDataForEdit(long foodId, EditText name, EditText desc, EditText price, EditText cat) {
        ...
        try (Cursor cursor = dbHelper.getReadableDatabase().query(FoodEntry.TABLE_NAME,
